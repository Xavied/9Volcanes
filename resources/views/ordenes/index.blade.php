...
@section('content')
    ...
    <div>
        <div class="text-center mt-3 mb-3">
            <a href="{{ route('ordenes.index')."?estado=1" }}" class="btn btn-danger">Pendientes: {{ $pendiente }} </a>
        ...
        <div class="text-center mb-3">
            <a href="{{ route('ordenes.index') }}" class="fs-4 text-uppercase text-muted text-decoration-none">Mis compras</a>
        </div>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <p>Estado: @switch($orden->estado) @case(1) Pendiente @break
                            ...
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('ordenes.show',$orden) }}" class="btn btn-primary mt-3">
                                        Ver
                                    </a>
                                </div>
                            </div>
