          ...
          <input type="hidden" name="idEditarProducto" id="idEditarProducto">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" value="0" step=".01" class="form-control" id="editarPrecio" name="editarPrecio" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="editarCantidad" class="form-label">Cantidad</label>
                    <input type="number" min="0" step="1" class="form-control" id="editarCantidad" name="editarCantidad" placeholder="">
                </div>                
                <div class="mb-3">
